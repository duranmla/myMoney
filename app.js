Ext.application({
    ...
    models: ["Transaccion", "Name", "Contactos", "Presupuesto", "SettingsValues", "HistorialGrafico"],
	stores: ['Contactos','Cuentas','Transacciones','Presupuestos', 'Categorias', 'MontoPresupuesto', 'Bancos', 'SettingsValues', 'HistorialGrafico'],
